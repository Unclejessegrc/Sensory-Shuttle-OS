...
drivers.forEach((d, index) => {
  ...
  d.certifications = [
    d.sensoryTrained ? "Sensory trained" : "Standard transport",
    d.pediatricCertified ? "Pediatric trained" : "Adult transport",
...
export const riders: Rider[] = [
  ...
  },
  {
    ...
    blockedDrivers: ["d3"],
    triggers: ["Unexpected route change", "Extra passengers", "Harsh braking", "Loud greetings"],
    deEscalationNotes:
      "Use first/then language, show visual schedule from caregiver, and wait quietly.",
    driverInstructions:
      "Out-of-district program dropoff. Calm voice required. No extra passengers.",
  ...
  },
  {
    ...
    blockedDrivers: ["d5"],
    triggers: ["Strong cleaner smell", "Rapid questions", "Stop-and-go driving"],
    deEscalationNotes: "Offer one clear choice at a time. Avoid touching backpack or headphones.",
    driverInstructions:
      "Speech therapy appointment. Booster required. Avoid harsh braking and strong scents.",
...
export const initialRides: Ride[] = [
  ...
  },
  {
    ...
    vehicleId: "v12",
    providerId: "p4",
    pickupAddress: "26 Pawtucket Ave",
    dropoffAddress: "Out-of-district learning program",
    appointmentDate: dateStr(0),
    appointmentTime: "08:30",
    appointmentType: "Out-of-district program",
    returnRideNeeded: true,
    caregiverAttending: true,
    specialInstructions:
      "Visual schedule helpful. No extra passengers. Calm voice required at handoff.",
    fundingSource: "School District",
    status: "scheduled",
    etaConfidence: "high",
    etaReasons: ["Preferred pediatric sensory-trained driver", "Quiet cabin matched"],
    gpsLastUpdateMin: 0,
    driverMoving: false,
    scheduledPickupISO: iso(8, 5),
    noSharedRideRequired: true,
    extraPassengers: 1,
    unrelatedSharedRiders: 0,
    estimatedDistanceMiles: 8,
    pickupLocationType: "Residence",
    dropoffLocationType: "Out-of-district program",
  },
  {
    id: "RD-1014",
    riderId: "r6",
    ...
    vehicleId: "v5",
    providerId: "p3",
    pickupAddress: "9 Cranston Rd",
    dropoffAddress: "Speech therapy clinic",
    appointmentDate: dateStr(0),
    ...
    caregiverAttending: false,
    specialInstructions:
      "Booster required. High sensory support. Avoid harsh braking and strong scents.",
    fundingSource: "Private Pay",
    status: "scheduled",
    etaConfidence: "low",
    etaReasons: [
      "Driver blocked on rider profile",
      "Vehicle missing booster",
      "Provider under review",
    ],
    gpsLastUpdateMin: 14,
    driverMoving: false,
    scheduledPickupISO: iso(13, 35),
    noSharedRideRequired: true,
    extraPassengers: 0,
    unrelatedSharedRiders: 0,
    estimatedDistanceMiles: 10,
    pickupLocationType: "Residence",
    dropoffLocationType: "Speech therapy clinic",
  },
  {
    id: "RD-0999",
    riderId: "r3",
...
export const initialIncidents: Incident[] = [
  ...
  },
  {
    ...
    driverId: "d5",
    providerId: "p3",
    issueType: "Wrong vehicle type",
    reporterStatement:
      "Demo warning case: booster equipment and sensory match must be confirmed before assignment.",
    status: "open",
    filedAt: iso(13, 42, 0),
  },
];
